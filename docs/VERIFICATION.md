...
- **Integration tests:** `npm test` passes all **68 tests in 9 files**. The new test covers the age wording (under a minute, minutes, hours, and days), and the status test checks the exact text.
