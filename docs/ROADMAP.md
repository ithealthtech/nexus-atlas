...
| **M3 Admin and scale** (next) | Groups UI, passkeys, recovery codes, SMTP notifications, expirations dashboard, tamper-evident audit log, REST API with API keys, CSV and IT Glue import, exports, migration from 0.2, branding, client portal | |
