...
| **M3b Data in and out** (next) | REST API with API keys and an OpenAPI spec, CSV and IT Glue import, per-client exports, migration from 0.2, branding, client portal | |
