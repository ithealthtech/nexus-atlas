...
| **M4 Release** (next) | Windows service installer, scheduled encrypted backups and restore, status page, performance and accessibility pass, security review, admin and user guides, v1.0 | |
